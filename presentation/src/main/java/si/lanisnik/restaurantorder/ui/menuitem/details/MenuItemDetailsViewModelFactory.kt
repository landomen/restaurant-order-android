 ...
 */
class MenuItemDetailsViewModelFactory @Inject constructor(private val shoppingCart: ShoppingCart) : ViewModelProvider.Factory {

    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(MenuItemDetailsViewModel::class.java))
            return MenuItemDetailsViewModel(shoppingCart) as T
