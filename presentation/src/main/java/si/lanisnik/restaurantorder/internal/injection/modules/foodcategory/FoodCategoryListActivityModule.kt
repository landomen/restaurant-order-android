...
open class FoodCategoryListActivityModule {
    ...
    @PerActivity
    @Provides
    fun provideCategoriesListViewModelFactory(getCategories: GetCategories,
                                              mapper: FoodCategoryMapper,
                                              shoppingCart: ShoppingCart): CategoriesListViewModelFactory =
            CategoriesListViewModelFactory(getCategories, mapper, shoppingCart)
